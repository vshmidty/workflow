sap.ui.define([
	...
	return BaseController.extend("workflow.controller.Master", {
		...
		onInit : function () {
            ...
            this.byId("titleImage").setSrc(sap.ui.require.toUrl("workflow/images/logo_ui5.png"));
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "workflow.view.ViewSettingsDialog",
					controller: this
